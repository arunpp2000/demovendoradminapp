...
import '../navbar/orders/adminOrders/b2bAdminOrderDetails.dart';
import '../navbar/request/sellerDetails.dart';
...
class _AdminUsersState extends State<AdminUsers> {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance.collection('admin_users')
    ...
    if(proceed){
    FirebaseFirestore.instance.collection('admin_users').doc(data![index].id).update({
    'delete':true,
    'verified':false,
    });
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                      ...
                                                      child: CachedNetworkImage(
                                                        imageUrl: data![index]['photo_url']==''?'https://cdn1.iconfinder.com/data/icons/ecommerce-gradient/512/ECommerce_Website_App_Online_Shop_Gradient_greenish_lineart_Modern_profile_photo_person_contact_account_buyer_seller-512.png':data[index]['photo_url'],
                                                      )
                                                  ),
                                                ],
                                              ),
                                                  ...
                                                  IconButton(
                                                    onPressed: () async {
                                                      ...
                                                      await FirebaseFirestore.instance.collection('branches').doc(currentBranchId).update(
                                                          {
                                                            'admins' :FieldValue.arrayRemove([data[index]['email']]),
                                                          });
                                                    },
                                                    icon: Icon(
                                                      Icons.delete,
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  IconButton(
                                                    onPressed: () async {
                                                      await FirebaseFirestore.instance.collection('admin_users').doc(data[index].id).update(
                                                          {
                                                            'verified':true
                                                          });
                                                      await FirebaseFirestore.instance.collection('branches').doc(currentBranchId).update(
                                                          {
                                                            'admins' :FieldValue.arrayUnion([data[index]['email']]),
                                                          });
                                                    },
                                                    icon: Icon(
                                                      Icons.verified,
