...
class B2bAdminOrderDetailsPage extends StatefulWidget {

  var id;

  var email;
  B2bAdminOrderDetailsPage({Key? key,  this.id,  }) : super(key: key);

  @override
  State<B2bAdminOrderDetailsPage> createState() => _B2bAdminOrderDetailsPageState();
}

class _B2bAdminOrderDetailsPageState extends State<B2bAdminOrderDetailsPage> {
