...
import '../b2b/b2bOrderDetails.dart';
import '../b2c/orderDetailsPage.dart';
import 'b2cSellerOrderDetails.dart';
...
class _SellerOrdersState extends State<SellerOrders>
  ...
  late Timestamp startOfWeek;
  late Timestamp endOfWeek;
  ...
  void initState() {
    ...
    startOfWeek =Timestamp.fromDate(DateTime(time.year, time.month, time.day - time.weekday + 1)) ;
    endOfWeek = Timestamp.fromDate(DateTime(time.year, time.month, time.day + (7 - time.weekday)));

    thisMonth =Timestamp.fromDate(DateTime(time.year,time.month,1,0,0,0,0,0));

    thisYear =Timestamp.fromDate(DateTime(time.year,4,1,0,0,0));


    datePicked1 = Timestamp.fromDate(DateTime(time.year, time.month, time.day, 0, 0, 0));
                        ...
                        if(index==0){
                          if (value == 'Today') {
                            ...
                            userStream1 = FirebaseFirestore.instance
                                ...
                                .where('placedDate', isLessThanOrEqualTo: today)
                                .orderBy('placedDate', descending: true)
                                .snapshots();
                            print('ppp');
                          ...
                          userStream1 = FirebaseFirestore.instance
                              ...
                              .where('orderStatus', isEqualTo: _b2cSelectedIndex)
                              .where('shipThrough', isEqualTo: true)
                              .where('placedDate', isGreaterThanOrEqualTo: startOfWeek)
                              .where('placedDate', isLessThanOrEqualTo: endOfWeek)
                              .orderBy('placedDate', descending: true)
                              .snapshots();
                          } else if (value == 'This Month') {   print(value);
                          userStream1 = FirebaseFirestore.instance
                              .collection('orders')
                              .where('orderStatus', isEqualTo: _b2cSelectedIndex)
                              .where('shipThrough', isEqualTo: true)
                              .where('placedDate', isGreaterThanOrEqualTo: thisMonth)
                              .orderBy('placedDate', descending: true)
                              .snapshots();
                          } else if (value == 'This Year') {   print(value);
                          userStream1 = FirebaseFirestore.instance
                              .collection('orders')
                              .where('orderStatus', isEqualTo: _b2cSelectedIndex)
                              .where('shipThrough', isEqualTo: true)
                              .where('placedDate', isLessThanOrEqualTo: thisYear)
                              .orderBy('placedDate', descending: true)
                              .snapshots();
                          }
                        }else{
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                          ...
                          onTap: () async {
                            ...
                            if (pickedDate != null) {
                              datePicked1 = Timestamp.fromDate(pickedDate);
                              print(datePicked1);
                              print(
                      ...
                      child: TextField(
                          ...
                          onTap: () async {
                            DateTime? pickedDate = await showDatePicker(
                                ...
                                lastDate: DateTime(2100));
                            if (pickedDate != null) {
                              datePicked2 = Timestamp.fromDate(pickedDate);
                              print(datePicked2);
                              print(
                                  pickedDate); //pickedDate output format => 2021-03-10 00:00:00.000
                              String formattedDate =
                                                            ...
                                                            builder: (context) =>
                                                                OrderDetailsPage(
                                                                  id: b2cData[
                                                                          listViewIndex]
                                                                      .id,
                                                                  email: userDataMap[b2cData[listViewIndex]['userId']]['email'],
                                                                )));
                                                  },
                                                  child: Container(
                                                    width: w * 1,
                                                                ...
                                                                userPhoto[b2cData[listViewIndex]
                                                                    ...
                                                                    ? CircleAvatar(
                                                                        ...
                                                                        child:
                                                                            CachedNetworkImage(
                                                                          imageUrl:
                                                                              userPhoto[b2cData[listViewIndex]['userId']] ?? "",
                                                                        ))
                                                                    : CircleAvatar(
                                                                        radius:
                                                                            20,
                                                                ...
                                                                userPhoto[b2bData[listViewIndex]
                                                                    ...
                                                                    ? CircleAvatar(
                                                                        ...
                                                                        child:
                                                                            CachedNetworkImage(
                                                                          imageUrl:
                                                                              userPhoto[b2bData[listViewIndex]['userId']] ?? "",
                                                                        ))
                                                                    : CircleAvatar(
                                                                        radius:
                                                                            20,
