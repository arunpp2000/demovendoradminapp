...
class B2cSellerOrderDetailsPage extends StatefulWidget {

  var id;

  var email;
  B2cSellerOrderDetailsPage({Key? key,  this.id,  }) : super(key: key);

  @override
  State<B2cSellerOrderDetailsPage> createState() => _B2cSellerOrderDetailsPageState();
}

class _B2cSellerOrderDetailsPageState extends State<B2cSellerOrderDetailsPage> {
