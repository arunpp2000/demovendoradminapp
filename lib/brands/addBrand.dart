                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.roboto(
                              textStyle: TextStyle(fontSize: w * 0.035,fontWeight: FontWeight.bold)),
                        ),
                        SizedBox(
                          width: w * 0.020,
                        ),
                        ...
                        TextButton(
                            onPressed: () {
                              print(galaryImagesUrls);
                              print(galaryimageUrl);
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                TextButton(
                                                  onPressed: () {
                                                    if(featureName.text.isNotEmpty){
                                                      getMultipleimages();
                                                      // featureName.clear();

                                                    }
                                                    else{ showUploadMessage(context,
                                                        "Enter Feature Name");}
                                                    print(featureImage);
                                                                ...
                                                                children: [
                                                                  Padding(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          color: Colors.white,
                                                                          image: DecorationImage(image: NetworkImage(downloadUrls[index]["link"]),fit: BoxFit.fill) ),
                                                                      // child: Image.file(
                                                                  ...
                                                                  Text(downloadUrls[index]["name"],style: TextStyle(color: Colors.black),)
                                                                ],
                                                              ),
                                                              Positioned(
                                                                left: w * 0.25,
                                            ...
                                            Container(
                                              ...
                                              child: GridView.builder(
                                                  physics: ScrollPhysics(),
                                                  itemCount: galaryImagesUrls.length,
                                                  shrinkWrap: true,
                                                  gridDelegate:
                                                  SliverGridDelegateWithMaxCrossAxisExtent(
                                                        ...
                                                        children:[
                                                          Padding(
                                                            ...
                                                            child: Container(
                                                              width: w * 0.400,
                                                              height: h * 100,
                                                              decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(galaryImagesUrls[index]),fit: BoxFit.fill)),
                                                              // child: Image.file(
                                                          ...
                                                          Positioned(
                                                            ...
                                                            child: InkWell(
                                                              onTap: () {
                                                                galaryImagesUrls.removeAt(index);
                                            ...
                                            Center(
                                              child: TextButton(
                                                onPressed: () async {
                                                  ...
                                                  if(image1!=""&&image2!=""&&brandName.text!=""&&brandtitle.text!=""&&couponCode.text!=""&&
                                                      contentDetails.text!="" )
                                                  {
                                                    {
                                                                  ...
                                                                  TextButton(
                                                                      ...
                                                                      onPressed: () async {
                                                                        var branddata = AddBrand(
                                                                            ...
                                                                            // youTube:[{
                                                                            //   "link": YoutubeVideoUrl.text,
                                                                            //   "tumbnail":""
                                                                            // }],
                                                                            // commissionPer:int.tryParse(commissionPer.text),
                                                                            youTube: youtubelink,
                                                                        ...
                                                                        showUploadMessage(context, 'Brand Added Successfully',);
                                                                        brandName.text='';
                                                                        contentDetails.text='';
                                                                        brandtitle.text='';
                                                                        YoutubeVideoUrl.text='';
